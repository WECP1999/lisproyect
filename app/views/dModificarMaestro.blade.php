        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <input type="text" id="txtId" disabled ng-model="maestroData.id" placeholder="Ejemplo: M####" class="form-control"/>
                </div>
                <div class="form-group">
                    <label for="txtUsuario">Ingresar nombre</label>
                    <input type="text" id="txtName" required ng-model="maestroData.nombre" class="form-control"/>
                </div>
                <div class="form-group">
                    <label for="txtUsuario">Ingresar apellido</label>
                    <input type="text" id="txtLastName" required ng-model="maestroData.apellido" class="form-control"/>
                </div>
                <div class="form-group">
                    <label for="txtUsuario">Ingresar nombre de usuario</label>
                    <input type="text" id="txtUser" required ng-model="maestroData.user" class="form-control"/>
                </div>
                <div class="form-group">
                    <label for="txtUsuario">Ingresar contraseña</label>
                    <input type="password" id="txtContra" required ng-model="maestroData.cont" class="form-control"/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="txtUsuario">Ingresar estado</label>
                    <select id="slEstado" required class="form-control" ng-model="maestroData.est"> 
                ...
                <div class="d-flex align-content-xl-end flex-wrap">
                    <button class="btn btn-info" ng-click="modificarMaestro()">INGRESAR</button>
                </div>
            </div>
        </div>
    </div>
