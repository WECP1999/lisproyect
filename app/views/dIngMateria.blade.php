        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <label for="txtName">Ingresar materia</label>
                    <input type="text" id="txtName" ng-model="nameMateria" class="form-control">
                </div>
                <div class="col-md-8"></div>
                <div class="d-flex align-content-xl-end flex-wrap">
                    <button class="btn btn-info" ng-click="ingresarMateria()">INGRESAR</button>
                </div>
            </div>
        </div>
    </div>
