            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtId" name="txtId" disabled ng-model="userData.id" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="txtUsuario">Ingresar materia</label>
                        <input type="text" id="txtName" ng-model="userData.nombre" class="form-control">
                    </div>
                    <div class="col-md-8"></div>
                    <div class="d-flex align-content-xl-end flex-wrap">
                        <button class="btn btn-info" ng-click="modificarMateria()">INGRESAR</button>
                    </div>
                </div>
            </div>
        </div>
