        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <input type="text" id="txtId" disabled ng-model="alumnoData.id" placeholder="Ejemplo: A####" class="form-control"/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select id="slEstado" required class="form-control" ng-model="alumnoData.est"> 
                ...
                <div class="d-flex align-content-xl-end flex-wrap">
                    <button class="btn btn-info" ng-click="modificarAlumno()">INGRESAR</button>
                </div>
            </div>
        </div>
    </div>
