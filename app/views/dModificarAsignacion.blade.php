    ...
    <div class="col-md-4">
        <div class="panel">
            ...
            <div class="form-group">
                ...
                <input type="text" id="txtId" disabled ng-model="asignacionData.id" placeholder="Ejemplo: A####" class="form-control"/>
            </div>
                <div class="form-group">
                ...
                <div class="d-flex align-content-xl-end flex-wrap">
                    <button class="btn btn-info" ng-click="modificarAsignacion()">INGRESAR</button>
                </div>
            </div>
        </div>
    </div>
