...
<div class="container">
    <div class="row">
      <table class="table table-striped table-bordered" style="background-color: white;">
        ...
        <tbody class="mostrar">
          <tr ng-repeat="m in asignacion">
            <td>
              <out val="m.id"/>
            </td>
            <td>
                <out val="m.ma"/> <out val="m.apellido"/>
            </td>
            <td>
                <out val="m.nombre"/>
            </td>
            ...
            <td>
                <a class="btn btn-success" into="href" val="m.id" cat="#!/d/modificar/asignacion/%s">MODIFICAR</a>
                <button class="btn btn-error" ng-click="eliminarAsignacion(m.id)">ELIMINAR</button>
            </td>
          </tr>
        </tbody>
      </table>
