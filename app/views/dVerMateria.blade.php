    ...
    <table class="table table-striped table-bordered" style="background-color: white;">
      ...
      <tbody class="mostrar">
        <tr ng-repeat="m in materias">
          ...
          <td>
              <a class="btn btn-success" into="href" val="m.id" cat="#!/d/modificar/materia/%s">MODIFICAR</a>
              <button class="btn btn-error" ng-click="eliminarrMateria(m.id)">ELIMINAR</button>
          </td>
        </tr>
      </tbody>
    </table>
